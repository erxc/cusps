...
write.csv(tau10_est, "WR_results/tau10_est_dml.csv", row.names = F)
write.csv(tau00_est, "WR_results/tau00_est_dml.csv", row.names = F)
write.csv(tau11_est, "WR_results/tau11_est_dml.csv", row.names = F)
