...
moment_pi_mu_wr_est <- function(df) {
  ...
  ## different misspecification scenarios
  ### define functions
  tauN10 <- function(z_i, d_i, tp_x_i, pY1_11_x_i, pY2_11_x_i, pY3_11_x_i, 
                     pY1_00_x_i, pY2_00_x_i, pY3_00_x_i,  
                     z_j, d_j, tp_x_j, pY1_11_x_j, pY2_11_x_j, pY3_11_x_j, 
    ...
    g10_oioj_g <- 0.5*((z_i*d_i/tp_x_i-(1-z_i)*d_i/(1-tp_x_i)) *
                         (z_j*d_j/tp_x_j-(1-z_j)*d_j/(1-tp_x_j)) * mu10_g_x_ij + 
                         (z_j*d_j/tp_x_j-(1-z_j)*d_j/(1-tp_x_j)) *
                         (z_i*d_i/tp_x_i-(1-z_i)*d_i/(1-tp_x_i)) * mu10_g_x_ji)
    
    g10_oioj_l <- 0.5*((z_i*d_i/tp_x_i-(1-z_i)*d_i/(1-tp_x_i)) *
                         (z_j*d_j/tp_x_j-(1-z_j)*d_j/(1-tp_x_j)) * mu10_l_x_ij + 
                         (z_j*d_j/tp_x_j-(1-z_j)*d_j/(1-tp_x_j)) * 
                         (z_i*d_i/tp_x_i-(1-z_i)*d_i/(1-tp_x_i)) * mu10_l_x_ji)

    return(c(mean(g10_oioj_g), mean(g10_oioj_l)))
  }
  
  tauN00 <- function(z_i, d_i, tp_x_i, pY1_10_x_i, pY2_10_x_i, pY3_10_x_i, 
                     pY1_00_x_i, pY2_00_x_i, pY3_00_x_i,
                     z_j, d_j, tp_x_j, pY1_10_x_j, pY2_10_x_j, pY3_10_x_j, 
                     pY1_00_x_j, pY2_00_x_j, pY3_00_x_j) {
    ...
    g00_oioj_g <- 0.5*((1-d_i*z_i/tp_x_i)*(1-d_j*z_j/tp_x_j) * mu00_g_x_ij +
                         (1-d_j*z_j/tp_x_j)*(1-d_i*z_i/tp_x_i) * mu00_g_x_ji)
    
    g00_oioj_l <- 0.5*((1-d_i*z_i/tp_x_i)*(1-d_j*z_j/tp_x_j) * mu00_l_x_ij +
                         (1-d_j*z_j/tp_x_j)*(1-d_i*z_i/tp_x_i) * mu00_l_x_ji)
    
    return(c(mean(g00_oioj_g), mean(g00_oioj_l)))
  }
  
  tauN11 <- function(z_i, d_i, tp_x_i, pY1_11_x_i, pY2_11_x_i, pY3_11_x_i, 
    ...
    g11_oioj_g <- 0.5*(d_i*(1-z_i)/(1-tp_x_i) * d_j*(1-z_j)/(1-tp_x_j) * mu11_g_x_ij + 
                         d_j*(1-z_j)/(1-tp_x_j) * d_i*(1-z_i)/(1-tp_x_i) * mu11_g_x_ji)
    
    g11_oioj_l <- 0.5*(d_i*(1-z_i)/(1-tp_x_i) * d_j*(1-z_j)/(1-tp_x_j) * mu11_l_x_ij + 
                         d_j*(1-z_j)/(1-tp_x_j) * d_i*(1-z_i)/(1-tp_x_i) * mu11_l_x_ji)
  ...
  ### tp-T, ps-T, oc-T
  tauN10_tpT_psT_ocT <- 
    tauN10(z_i = dfp$z, d_i = dfp$d, tp_x_i = dfp$tp_x, 
           pY1_11_x_i = dfp$pY1_11_x, pY2_11_x_i = dfp$pY2_11_x, pY3_11_x_i = dfp$pY3_11_x, 
           pY1_00_x_i = dfp$pY1_00_x, pY2_00_x_i = dfp$pY2_00_x, pY3_00_x_i = dfp$pY3_00_x,
           z_j = dfp$z_2, d_j = dfp$d_2, tp_x_j = dfp$tp_x_2, 
           pY1_11_x_j = dfp$pY1_11_x_2, pY2_11_x_j = dfp$pY2_11_x_2, pY3_11_x_j = dfp$pY3_11_x_2, 
           pY1_00_x_j = dfp$pY1_00_x_2, pY2_00_x_j = dfp$pY2_00_x_2, pY3_00_x_j = dfp$pY3_00_x_2)
  
  tauN00_tpT_psT_ocT <- 
    tauN00(z_i = dfp$z, d_i = dfp$d, tp_x_i = dfp$tp_x, 
           pY1_10_x_i = dfp$pY1_10_x, pY2_10_x_i = dfp$pY2_10_x, pY3_10_x_i = dfp$pY3_10_x, 
           pY1_00_x_i = dfp$pY1_00_x, pY2_00_x_i = dfp$pY2_00_x, pY3_00_x_i = dfp$pY3_00_x,
           z_j = dfp$z_2, d_j = dfp$d_2, tp_x_j = dfp$tp_x_2, 
           pY1_10_x_j = dfp$pY1_10_x_2, pY2_10_x_j = dfp$pY2_10_x_2, pY3_10_x_j = dfp$pY3_10_x_2, 
           pY1_00_x_j = dfp$pY1_00_x_2, pY2_00_x_j = dfp$pY2_00_x_2, pY3_00_x_j = dfp$pY3_00_x_2)
  
  tauN11_tpT_psT_ocT <- 
    tauN11(z_i = dfp$z, d_i = dfp$d, tp_x_i = dfp$tp_x, 
           pY1_11_x_i = dfp$pY1_11_x, pY2_11_x_i = dfp$pY2_11_x, pY3_11_x_i = dfp$pY3_11_x, 
           pY1_01_x_i = dfp$pY1_01_x, pY2_01_x_i = dfp$pY2_01_x, pY3_01_x_i = dfp$pY3_01_x,
           z_j = dfp$z_2, d_j = dfp$d_2, tp_x_j = dfp$tp_x_2, 
           pY1_11_x_j = dfp$pY1_11_x_2, pY2_11_x_j = dfp$pY2_11_x_2, pY3_11_x_j = dfp$pY3_11_x_2, 
           pY1_01_x_j = dfp$pY1_01_x_2, pY2_01_x_j = dfp$pY2_01_x_2, pY3_01_x_j = dfp$pY3_01_x_2)
  
  ### tp-F, ps-T, oc-T
  tauN10_tpF_psT_ocT <- 
    tauN10(z_i = dfp$z, d_i = dfp$d, tp_x_i = dfp$tp_x_m, 
           pY1_11_x_i = dfp$pY1_11_x, pY2_11_x_i = dfp$pY2_11_x, pY3_11_x_i = dfp$pY3_11_x, 
           pY1_00_x_i = dfp$pY1_00_x, pY2_00_x_i = dfp$pY2_00_x, pY3_00_x_i = dfp$pY3_00_x,
           z_j = dfp$z_2, d_j = dfp$d_2, tp_x_j = dfp$tp_x_m_2, 
           pY1_11_x_j = dfp$pY1_11_x_2, pY2_11_x_j = dfp$pY2_11_x_2, pY3_11_x_j = dfp$pY3_11_x_2, 
           pY1_00_x_j = dfp$pY1_00_x_2, pY2_00_x_j = dfp$pY2_00_x_2, pY3_00_x_j = dfp$pY3_00_x_2)
  
  tauN00_tpF_psT_ocT <- 
    tauN00(z_i = dfp$z, d_i = dfp$d, tp_x_i = dfp$tp_x_m, 
           pY1_10_x_i = dfp$pY1_10_x, pY2_10_x_i = dfp$pY2_10_x, pY3_10_x_i = dfp$pY3_10_x, 
           pY1_00_x_i = dfp$pY1_00_x, pY2_00_x_i = dfp$pY2_00_x, pY3_00_x_i = dfp$pY3_00_x,
           z_j = dfp$z_2, d_j = dfp$d_2, tp_x_j = dfp$tp_x_m_2, 
           pY1_10_x_j = dfp$pY1_10_x_2, pY2_10_x_j = dfp$pY2_10_x_2, pY3_10_x_j = dfp$pY3_10_x_2, 
  ...
  tauN11_tpF_psT_ocT <- 
    tauN11(z_i = dfp$z, d_i = dfp$d, tp_x_i = dfp$tp_x_m, 
           pY1_11_x_i = dfp$pY1_11_x, pY2_11_x_i = dfp$pY2_11_x, pY3_11_x_i = dfp$pY3_11_x, 
           pY1_01_x_i = dfp$pY1_01_x, pY2_01_x_i = dfp$pY2_01_x, pY3_01_x_i = dfp$pY3_01_x,
           z_j = dfp$z_2, d_j = dfp$d_2, tp_x_j = dfp$tp_x_m_2, 
           pY1_11_x_j = dfp$pY1_11_x_2, pY2_11_x_j = dfp$pY2_11_x_2, pY3_11_x_j = dfp$pY3_11_x_2, 
  ...
  tauN10_tpT_psT_ocF <- 
    tauN10(z_i = dfp$z, d_i = dfp$d, tp_x_i = dfp$tp_x, 
           pY1_11_x_i = dfp$pY1_11_x_m, pY2_11_x_i = dfp$pY2_11_x_m, pY3_11_x_i = dfp$pY3_11_x_m, 
           pY1_00_x_i = dfp$pY1_00_x_m, pY2_00_x_i = dfp$pY2_00_x_m, pY3_00_x_i = dfp$pY3_00_x_m,
           z_j = dfp$z_2, d_j = dfp$d_2, tp_x_j = dfp$tp_x_2, 
           pY1_11_x_j = dfp$pY1_11_x_m_2, pY2_11_x_j = dfp$pY2_11_x_m_2, pY3_11_x_j = dfp$pY3_11_x_m_2, 
           pY1_00_x_j = dfp$pY1_00_x_m_2, pY2_00_x_j = dfp$pY2_00_x_m_2, pY3_00_x_j = dfp$pY3_00_x_m_2)
  
  tauN00_tpT_psT_ocF <- 
    tauN00(z_i = dfp$z, d_i = dfp$d, tp_x_i = dfp$tp_x, 
           pY1_10_x_i = dfp$pY1_10_x_m, pY2_10_x_i = dfp$pY2_10_x_m, pY3_10_x_i = dfp$pY3_10_x_m, 
           pY1_00_x_i = dfp$pY1_00_x_m, pY2_00_x_i = dfp$pY2_00_x_m, pY3_00_x_i = dfp$pY3_00_x_m,
           z_j = dfp$z_2, d_j = dfp$d_2, tp_x_j = dfp$tp_x_2, 
           pY1_10_x_j = dfp$pY1_10_x_m_2, pY2_10_x_j = dfp$pY2_10_x_m_2, pY3_10_x_j = dfp$pY3_10_x_m_2, 
           pY1_00_x_j = dfp$pY1_00_x_m_2, pY2_00_x_j = dfp$pY2_00_x_m_2, pY3_00_x_j = dfp$pY3_00_x_m_2)
  
  tauN11_tpT_psT_ocF <- 
    tauN11(z_i = dfp$z, d_i = dfp$d, tp_x_i = dfp$tp_x, 
           pY1_11_x_i = dfp$pY1_11_x_m, pY2_11_x_i = dfp$pY2_11_x_m, pY3_11_x_i = dfp$pY3_11_x_m, 
           pY1_01_x_i = dfp$pY1_01_x_m, pY2_01_x_i = dfp$pY2_01_x_m, pY3_01_x_i = dfp$pY3_01_x_m,
           z_j = dfp$z_2, d_j = dfp$d_2, tp_x_j = dfp$tp_x_2, 
           pY1_11_x_j = dfp$pY1_11_x_m_2, pY2_11_x_j = dfp$pY2_11_x_m_2, pY3_11_x_j = dfp$pY3_11_x_m_2, 
           pY1_01_x_j = dfp$pY1_01_x_m_2, pY2_01_x_j = dfp$pY2_01_x_m_2, pY3_01_x_j = dfp$pY3_01_x_m_2)
