...
moment_pi_p_wr_est <- function(df) {
  ...
  tauN11 <- function(z_i, d_i, y_i, ps1_x_i, ps0_x_i, tp_x_i,
    ...
    g11_oioj_g <- 0.5*(z_i*d_i*ps0_x_i/(tp_x_i*ps1_x_i) * (1-z_j)*d_j/(1-tp_x_j) * (1*(y_i>y_j)) +
                         z_j*d_j*ps0_x_j/(tp_x_j*ps1_x_j) * (1-z_i)*d_i/(1-tp_x_i) * (1*(y_j>y_i)))
    
    g11_oioj_l <- 0.5*(z_i*d_i*ps0_x_i/(tp_x_i*ps1_x_i) * (1-z_j)*d_j/(1-tp_x_j) * (1*(y_i<y_j)) +
                         z_j*d_j*ps0_x_j/(tp_x_j*ps1_x_j) * (1-z_i)*d_i/(1-tp_x_i) * (1*(y_j<y_i)))
